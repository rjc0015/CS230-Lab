    ...
    <div class="h-50 center-me text-center">
        <div class="my-auto">
         ...
         <input type ="text"name="title" class="form-control" placeholder="title" >
                ...
                <div class="form-group">
                    <textarea name="descript" id="bio" cols="30" rows="10" placeholder="bio..."style="text-align:center;"></textarea>
                </div>
                <div class="form-group">
                    <button type="submit" name="gallery-submit" class="btn btn-outline-success">upload</button>
                </div>
            </form>
        </div>
